...
def load_reference_data() -> tuple[dict[str, float], dict[str, float]]:
    ...
    Returns:
        A tuple of (region_lookup, discount_lookup) dictionaries.
    """
...
def process_message(
    ...
    *,
    ...
    Arguments:
        ...
        discount_lookup: Discount rates by discount_code.
    ...
    LOG.info(f"price_after_discount={enriched['price_after_discount']}")
